export default function QuadraticEquations() {
    return (
        <div className="grid items-center justify-items-center">
            ...
            <p>The standard/ general form of a quadratic equation is .y = ax +2 bx + c</p>
            <p>● We can solve problems involving quadratic relations by sketching its graph</p>
            <p>● We can sketch its graph by creating a t</p>
