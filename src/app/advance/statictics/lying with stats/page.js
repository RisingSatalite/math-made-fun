export default function __Default__() {
    //Insert examples of lying with statictics
    return (
        <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
            <h1>It is very easy to lie with charts</h1>
            <p>Save 75$ vs 75%</p>
            <p>Save 75$, 1200 to 1125</p>
            <p>Save 75%, 100 to 25</p>
            <p>Show graph from 0%, from data, or full 100%, all hide data or amplfy data</p>
